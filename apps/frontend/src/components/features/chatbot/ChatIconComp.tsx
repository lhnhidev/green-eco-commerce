  ...
  return (
    <div className="fixed bottom-24 lg:bottom-10 right-6 lg:right-10 z-50">
      <div className="relative group cursor-pointer">
        ...
        {/* Main button */}
        <div className="relative flex items-center justify-center w-14 h-14 bg-linear-to-br from-green-500 to-emerald-700 text-white rounded-full shadow-lg hover:scale-105 transition-transform duration-300">
