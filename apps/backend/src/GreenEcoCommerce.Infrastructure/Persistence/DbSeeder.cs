...
public static class DbSeeder
{
    ...
    private static async Task SeedOrdersAsync(ApplicationDbContext context)
    {
        ...
        {
            new() { Id = new Guid("77000000-0000-0000-0000-000000000001"), UserId = new Guid("44000000-0000-0000-0000-000000000002"), Status = OrderStatusEnum.Delivered,  DeliveryAddress = "45 Le Loi, District 3, Ho Chi Minh City",                    DiscountAmount = 0m,    EarnedPoints = 25, CreatedAt = DateTimeOffset.UtcNow.AddDays(-90) },
            new() { Id = new Guid("77000000-0000-0000-0000-000000000002"), UserId = new Guid("44000000-0000-0000-0000-000000000002"), Status = OrderStatusEnum.Delivered,  DeliveryAddress = "45 Le Loi, District 3, Ho Chi Minh City",                    DiscountAmount = 5.00m, EarnedPoints = 40, CreatedAt = DateTimeOffset.UtcNow.AddDays(-60) },
            new() { Id = new Guid("77000000-0000-0000-0000-000000000003"), UserId = new Guid("44000000-0000-0000-0000-000000000003"), Status = OrderStatusEnum.Delivered,  DeliveryAddress = "78 Tran Hung Dao, District 5, Ho Chi Minh City",            DiscountAmount = 0m,    EarnedPoints = 15, CreatedAt = DateTimeOffset.UtcNow.AddDays(-80) },
            new() { Id = new Guid("77000000-0000-0000-0000-000000000004"), UserId = new Guid("44000000-0000-0000-0000-000000000004"), Status = OrderStatusEnum.Packing,    DeliveryAddress = "12 Dinh Tien Hoang, Binh Thanh District, Ho Chi Minh City", DiscountAmount = 0m,    EarnedPoints = 20, CreatedAt = DateTimeOffset.UtcNow.AddDays(-3)  },
            new() { Id = new Guid("77000000-0000-0000-0000-000000000005"), UserId = new Guid("44000000-0000-0000-0000-000000000005"), Status = OrderStatusEnum.Pending,    DeliveryAddress = "56 Nguyen Thi Minh Khai, District 1, Ho Chi Minh City",   DiscountAmount = 0m,    EarnedPoints = 8,  CreatedAt = DateTimeOffset.UtcNow.AddDays(-1)  },
            new() { Id = new Guid("77000000-0000-0000-0000-000000000006"), UserId = new Guid("44000000-0000-0000-0000-000000000006"), Status = OrderStatusEnum.Delivered,  DeliveryAddress = "30 Pasteur, District 1, Ho Chi Minh City",                  DiscountAmount = 10.00m,EarnedPoints = 60, CreatedAt = DateTimeOffset.UtcNow.AddDays(-45) },
            new() { Id = new Guid("77000000-0000-0000-0000-000000000007"), UserId = new Guid("44000000-0000-0000-0000-000000000007"), Status = OrderStatusEnum.Delivering, DeliveryAddress = "89 Ly Tu Trong, District 1, Ho Chi Minh City",              DiscountAmount = 0m,    EarnedPoints = 10, CreatedAt = DateTimeOffset.UtcNow.AddDays(-2)  },
            new() { Id = new Guid("77000000-0000-0000-0000-000000000008"), UserId = new Guid("44000000-0000-0000-0000-000000000008"), Status = OrderStatusEnum.Cancelled,  DeliveryAddress = "25 Vo Van Tan, District 3, Ho Chi Minh City",               DiscountAmount = 0m,    EarnedPoints = 0,  CreatedAt = DateTimeOffset.UtcNow.AddDays(-15) },
            new() { Id = new Guid("77000000-0000-0000-0000-000000000009"), UserId = new Guid("44000000-0000-0000-0000-000000000009"), Status = OrderStatusEnum.Delivered,  DeliveryAddress = "67 Nguyen Du, District 1, Ho Chi Minh City",                DiscountAmount = 2.00m, EarnedPoints = 9,  CreatedAt = DateTimeOffset.UtcNow.AddDays(-20) },
            new() { Id = new Guid("77000000-0000-0000-0000-000000000010"), UserId = new Guid("44000000-0000-0000-0000-000000000010"), Status = OrderStatusEnum.Packing,    DeliveryAddress = "34 Hai Ba Trung, District 1, Ho Chi Minh City",             DiscountAmount = 0m,    EarnedPoints = 11, CreatedAt = DateTimeOffset.UtcNow.AddDays(-1)  },
            new() { Id = new Guid("77000000-0000-0000-0000-000000000011"), UserId = new Guid("44000000-0000-0000-0000-000000000011"), Status = OrderStatusEnum.Pending,    DeliveryAddress = "101 Cach Mang Thang 8, District 10, Ho Chi Minh City",     DiscountAmount = 0m,    EarnedPoints = 5,  CreatedAt = DateTimeOffset.UtcNow              },
        };
