...
public record CreateCheckoutProductsCommand(List<ProductInfo> ProductList)
        : IRequest<CreateCheckoutProductsCommandResponse>
{
    public class Handler(IProductRepository productRepository)
            : IRequestHandler<CreateCheckoutProductsCommand, CreateCheckoutProductsCommandResponse>
    {
        public async Task<CreateCheckoutProductsCommandResponse> Handle(CreateCheckoutProductsCommand command,
